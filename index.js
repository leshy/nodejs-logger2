...
(function() {
  var Backbone, Console, Logger, Udp, UdpGun, _, colors, fs, h, os, settings, subscriptionMan,
    slice = [].slice;
  ...
  Logger = exports.Logger = subscriptionMan.basic.extend4000({
    ...
    log: function() {
      ...
      msg = arguments[0], data = arguments[1], tags = 3 <= arguments.length ? slice.call(arguments, 2) : [];
      if (data == null) {
        data = {};
      }
      tags = _.flatten(tags);
  ...
  Udp = exports.Udp = Backbone.Model.extend4000({
    name: 'udp',
    initialize: function(settings1) {
      this.settings = settings1 != null ? settings1 : {
        host: 'localhost',
        port: 6000
      };
